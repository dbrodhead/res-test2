...
class TrainingDaysControllerTest < ActionController::TestCase
  ...
  test "should create training_day" do
    assert_difference('TrainingDay.count') do
      post :create, training_day: { details: @training_day.details, t_cal_day_id: @training_day.t_cal_day_id, weekday: @training_day.weekday }
    end
  ...
  test "should update training_day" do
    put :update, id: @training_day, training_day: { details: @training_day.details, t_cal_day_id: @training_day.t_cal_day_id, weekday: @training_day.weekday }
    assert_redirected_to training_day_path(assigns(:training_day))
  end
